...
void update_listener(
	...
	float listener_look_at_x,
	float listener_look_at_y,
	float listener_look_at_z,
	float listener_up_x,
	float listener_up_y,
	float listener_up_z
) {
	ALfloat listenerPos[] = {listener_position_x, listener_position_y, listener_position_z};
	ALfloat listenerVel[] = {listener_velocity_x, listener_velocity_y, listener_velocity_z};
	ALfloat listenerOri[] = {
		listener_look_at_x, listener_look_at_y, listener_look_at_z,
